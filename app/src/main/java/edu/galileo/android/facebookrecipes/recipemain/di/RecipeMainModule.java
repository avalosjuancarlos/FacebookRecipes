...
public class RecipeMainModule {
    ...
    @Provides
    @Singleton
    RecipeMainPresenter providesRecipeMainPresenter(EventBus eventBus, RecipeMainView view,
                                                    SaveRecipeInteractor saveInteractor,
                                                    GetNextRecipeInteractor nextInteractor){
        return new RecipeMainPresenterImpl(eventBus, view, saveInteractor, nextInteractor);
    }
